...
describe('most liked blog', () => {
  ...
  test('of a bigger list is correct blog is chosen', () => {
...
describe('most blogs', () => {
  ...
  test('of a bigger list is correct author is chosen', () => {
...
describe('most likes', () => {
  ...
  test('when list has only one blog, the likes of that blog', () => {
